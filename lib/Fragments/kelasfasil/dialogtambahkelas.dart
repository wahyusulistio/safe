...
class MyDialogTambahKelas extends StatefulWidget {
  const MyDialogTambahKelas({Key? key, required this.nip}) : super(key: key);

  final String nip;

  @override
  State<MyDialogTambahKelas> createState() => _MyDialogTambahKelasState();
}

class _MyDialogTambahKelasState extends State<MyDialogTambahKelas> {
