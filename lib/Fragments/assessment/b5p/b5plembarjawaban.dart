...
class B5PLembarJawaban extends StatefulWidget {
  B5PLembarJawaban(
      {Key? key,
  ...
  @override
  State<B5PLembarJawaban> createState() => _B5PLembarJawabanState();
}

class _B5PLembarJawabanState extends State<B5PLembarJawaban> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        //                       );
        //                       //Get.back();
        //                       var req = await apiService.getSkorB5P(user: nip,
        ...
        //                           thb.add(HasilB5P.fromJSON(jsonDecode(req.body)['data'][i]));
        //                         }
        //                       }
        //                       Get.off(()=>HasilB5PPeserta(hb: thb,));
        //                     }
        //                   } else {
        //                     await Get.defaultDialog(
        //                       content: MyDialogInfo(info: masalahvalid),
