...
import 'package:safe/Fragments/kelaspeserta/dialogjoinkelas.dart';
import 'package:safe/Fragments/kelaspeserta/kelasitem2.dart';
...
class KelasPeserta extends StatefulWidget {
  @override
  _KelasPesertaState createState() => _KelasPesertaState();
}

class _KelasPesertaState extends State<KelasPeserta>  with WidgetsBindingObserver {
...
//  static String jwttoken = "";
  ...
  late List<Kelas> kelaspesertas = <Kelas>[];
  ...
  Future<void> getKelasPeserta() async {
    isLoading=true;
    var req = await apiService.getKelasPeserta(nip);
...
/*  @override
  ...
  Widget build(BuildContext context) {
    ...
    final makeBody = (kelaspesertas.length>0 && isLoading==false) ? Container(
      // decoration: BoxDecoration(color: Color.fromRGBO(58, 66, 86, 1.0)),
      child: ListView.builder(
        scrollDirection: Axis.vertical,
        shrinkWrap: false,
        itemCount: kelaspesertas.length,
        itemBuilder: (BuildContext context, int index) {
          return KelasItem2(kelas: kelaspesertas[index]);  //makeCard(mails[index]);
        },
        controller: _sc,
      ),
    ) : (isLoading==true ? Center(child: CircularProgressIndicator(),) : Center(
      child: Card(
        elevation: 20,
        color: Colors.teal,
        ...
        child: Container(
          ...
          //color: Colors.teal,
          child: Center(
            child: AutoSizeText("Maaf tidak ada Tools yang aktif di kelas Anda.",
